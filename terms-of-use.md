...
This service (“the Service”) allows users to publish and manage websites and content using version-controlled files and third-party authentication providers.
...
The Service is intended for individuals 13 years of age or older.
...
Access to the Service is provided through third-party OAuth authentication providers.

We do not issue usernames or passwords directly.
...
You retain full ownership of all content you publish using the Service.

By publishing content, you grant the Service a limited, non-exclusive license to host, display, and distribute that content solely for the purpose of operating the Service.
...
Content published through the Service may be publicly accessible by default.
...
We may modify, suspend, or discontinue any part of the Service at any time without guarantee of availability or uptime.
