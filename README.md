...
### Image support
The application will be able to handle image uploads that convert to AVIF and supports image sizing and displays correctly on mobile

### Zip file download
The application will be able to generate a downloadable zip file containing the website source code that can be deployed to any number of site hosts:
* NeoCities (drag and drop files in the `public/` directory)
* Cloudflare Pages (link the GitHub or GitLab repository directly, or do a zip file upload)
